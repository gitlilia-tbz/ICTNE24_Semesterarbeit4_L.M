...
graph TB
    ...
    classDef aws fill:#fff3e0,stroke:#f57c00,stroke-width:3px
    classDef k8s fill:#e8f5e9,stroke:#43a047,stroke-width:3px
    classDef service fill:#bbdefb,stroke:#1976d2,stroke-width:2px
    classDef support fill:#fff9c4,stroke:#fbc02d,stroke-width:2px
    classDef db fill:#b3e5fc,stroke:#0288d1,stroke-width:3px
